...
function Main_report() {
  ...
  if (!cashData || cashData.length === 0)
    return <h4 className="text-center text-danger">Loading or No Data</h4>;
  return (
    <div className="allworking boxdesign py-3">
                ...
                >
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>Type</td>
                      <td colSpan="2">
                        {cashData.update_ty === "U" ? "Updated" : "Created"}
                      </td>
                    </tr>
                  </tbody>
                </table>
