...
function General_Setting() {
  return (
    <div className="setting allworking border p-2">
      <span className="fs-4 fw-semibold">System Settings</span>
      <div className="d-md-flex mt-3 gap-4 flex-wrap">
        <div className="div1 p-2 bg-light rounded-2 border-top border-warning border-3 shadow-sm ">
          <div className="imgdiv"><img src="http://"/></div>
          <br />
          <button className="btn btn-sm btn-dark my-2 px-3">Edit Logo</button>
        </div>
        <div className="flex-fill px-2 bg-light rounded-2 border-top border-warning border-3 shadow-sm">
